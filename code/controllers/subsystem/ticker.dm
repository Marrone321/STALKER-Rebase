...
/datum/controller/subsystem/ticker/proc/setup()
	...
	to_chat(world, SPAN_NOTICE("<FONT color='red'><B>You encroach upon the Zone. Be wary, and keep your wits about you.</B></FONT>"))
	SEND_SOUND(world, sound('sound/effects/start.ogg', volume = 40))
