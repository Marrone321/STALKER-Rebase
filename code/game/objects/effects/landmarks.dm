...
/obj/effect/landmark/start/army
	job_listing_type = /datum/job_listing/army
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/bandit
	job_listing_type = /datum/job_listing/bandit
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/clearsky
	job_listing_type = /datum/job_listing/clearsky
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/duty
	job_listing_type = /datum/job_listing/duty
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/ecologist
	job_listing_type = /datum/job_listing/ecologist
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/freedom
	job_listing_type = /datum/job_listing/freedom
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/mercenary
	job_listing_type = /datum/job_listing/mercenary
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/monolith
	job_listing_type = /datum/job_listing/monolith
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/renegade
	job_listing_type = /datum/job_listing/renegade
	roundstart = TRUE
	latejoin = TRUE

/obj/effect/landmark/start/stalker
	job_listing_type = /datum/job_listing/stalker
	roundstart = TRUE
	latejoin = TRUE
